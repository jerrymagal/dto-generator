...
public abstract class CopyOfReflectUtil {
	...
	protected static void setField(Object value, Object target, Field fieldTarget, Field fieldValue) {
		DTOPropertyTarget attValue = fieldValue.getAnnotation(DTOPropertyTarget.class);
		DTOPropertyTarget attTarget = fieldTarget.getAnnotation(DTOPropertyTarget.class);
